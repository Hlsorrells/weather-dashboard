$(document).ready(function () {
    ...
    $("form").on("submit", function (event) {
        ...
        function getUVindex(cityCoord) {
            ...
            $.ajax({
                url: "https://api.openweathermap.org/data/2.5/uvi?appid=c9288340a0d00c00e02bf6e9f809e872&lat=" + cityCoord[0] + "&lon=" + cityCoord[1],
                method: "GET"
            }).then(function (response) {
        ...
        $.ajax({
            ...
            for (var i = 1; i < 6; i++) {
                ...
                var img = $("<img>").attr("src", "https://openweathermap.org/img/w/" + response.list[i].weather[0].icon + ".png").attr("style" , "width: 100px;")
